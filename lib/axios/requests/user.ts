...
import { USER, USER_CRM, USER_GET_JUNIORS, USER_GET_REFERRAL_LINK, USER_GET_TIME_REPORT, USER_GET_TIME_Work, USER_ME_UPDATE_PHOTO, USER_PHOTO_INFO } from "../endpoint";
import { IApiResponse } from "../types/base";
import { IReportTime, IWorkTime } from "../types/time";
import { IApplicationUser, ICrmUser, IJunior, IUserPhoto, IUserRefLink } from "../types/user";
