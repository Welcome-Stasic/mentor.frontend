...
export const AUTH_GOOGLE_LOGIN = "Auth/GoogleLogin";
// export const AUTH_SENDCODE_LOGIN = "Auth/SendCodeSMS";
// export const AUTH_CODESYCCESS_LOGIN = "Auth/LoginSMSCode";
...
export const USER_GET_JUNIORSOLD = "User/JuniorsOld";
